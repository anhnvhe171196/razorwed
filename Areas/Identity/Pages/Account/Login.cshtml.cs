...
namespace _12_EntityFramworkEx.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Display(Name = "Nhớ thông tin đang nhập?")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Đăng nhập thàng công.");
                ...
                {
                    _logger.LogWarning("Tài khoản của bạn bị khóa.");
                    return RedirectToPage("./Lockout");
                }
                else
                {
                    ModelState.AddModelError(string.Empty, "Thật bại, tài khoản không tồn tại hoặc sai UserName, Password.");
                    return Page();
                }
            }
